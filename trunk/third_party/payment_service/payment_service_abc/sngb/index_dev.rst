...
.. seealso::
    ...
    `Документация по API`_.

.. _Документация по API: http://ecomm.sngb.ru/docs
...
+============================+=============================+====================+
| `Хусаинов Артур Амурович`_ | ведущий инженер-программист | `(3462) 39-83-38`_ |
+----------------------------+-----------------------------+--------------------+
|                            | техподдержка                | `(800) 775-88-04`_ |
+----------------------------+-----------------------------+--------------------+

.. _Хусаинов Артур Амурович: mailto:a.khusainov@sngb.ru
.. _(3462) 39-83-38: tel:+73462398338
.. _(800) 775-88-04: tel:+78007758804
...
.. glossary::
    ...
    **HostedPaymentPage (HPP)**
        `Платёжная форма банка`_, на которой клиент вводит данные своей банковской карты.
    ...
    **PaymentInitServlet**
        `Сервлет для инициализации новой оплаты`_. Формирует уникальный номер оплаты *PaymentID* и URL платёжной формы *HostedPaymentPage*, на которую нужно перенаправить покупателя после успешного создания оплаты.
...
.. _Платёжная форма банка: https://ecm.sngb.ru/Gateway/hppaction

.. _Сервлет для инициализации новой оплаты: https://ecm.sngb.ru/Gateway/PaymentInitServlet
