    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_service_scheme_id', models.PositiveIntegerField(verbose_name='ID схемы в сервисе продажи билетов')),
                ('ticket_service_scheme_title', models.CharField(max_length=128, verbose_name='Название схемы в сервисе продажи билетов')),
