...
from third_party.ticket_service.cache import TicketServiceCache
from third_party.payment_service.cache import PaymentServiceCache


CACHE_CLASSES = (EventCache, TicketServiceCache, PaymentServiceCache, )
...
def cache_factory(entity, object_id, reset=False, **kwargs):
    ...
    Args:
        entity (str): Название модели или другой сущности для создания кэша (хранится как атрибут его класса).
