...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='event_venue',
            field=models.ManyToManyField(blank=True, related_name='domain_ticket_service_venues', through='ticket_service.TicketServiceVenueBinder', to='event.EventVenue', verbose_name='Зал'),
        ),
        migrations.AddField(
            model_name='ticketservice',
        ...
        migrations.AlterUniqueTogether(
            name='ticketservicevenuebinder',
            unique_together=set([('ticket_service', 'ticket_service_event_venue_id', 'ticket_service_event_venue_title')]),
        ),
    ]
