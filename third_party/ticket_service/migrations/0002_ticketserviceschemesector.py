    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_service_sector_id', models.PositiveIntegerField(verbose_name='ID сектора в схеме зала')),
                ('ticket_service_sector_title', models.CharField(max_length=128, verbose_name='Название сектора в схеме зала')),
