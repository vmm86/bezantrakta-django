    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.CharField(choices=[('self', 'Получение в кассе'), ('courier', 'Доставка курьером'), ('email', 'Электронный билет на email')], default='self', max_length=16, verbose_name='Получение билетов')),
