...
BEZANTRAKTA_DEFAULT_PROMOTER = 'ООО «БЕЛЬКАНТО» ИНН 3662243480'
# Реквизиты продавца
BEZANTRAKTA_DEFAULT_SELLER = 'ИП Карюков Игорь Леонидович ИНН 366202613092 ОГРНИП 313366803500228'
...
DEBUG = False
BEZANTRAKTA_DEBUG_CONSOLE = False
