...
Версия 3.8
==========
Большие обновления в документации.
...
.. only:: dev
  ...
  При изменении ID схемы зала в импортированном ранее событии при работе задания ``ts_discover`` обновляется не только ID схемы зала, но и ID зала, к которому она привязана.
