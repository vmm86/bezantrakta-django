    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(verbose_name='Дата заказа')),
                ...
                ('delivery', models.CharField(choices=[('self', 'Получение в кассе'), ('courier', 'Доставка курьером'), ('email', 'Электронный билет')], default='self', max_length=16, verbose_name='Получение билетов')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('row_id', models.PositiveIntegerField(null=True, verbose_name='ID ряда')),
