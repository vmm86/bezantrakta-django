...
* сделать **возврат стоимости заказа** (по запросу покупателя или при переносе/отмене события).
* **повторно отправить сообщение о заказе покупателю** (с вложенными электронными билетами, если они были заказаны), например, если покупатель в ходе заказа ввёл неверный email-адрес.
