...
Поскольку в одном городе может быть создано более одного сайта (главный сайт "**Воронеж**" и "**Воронеж (ТОБ)**" в Воронеже), города отделены от сайтов и хранятся отдельно. Сначала создаётся новый город, а затем в привязке к нему создаётся новый сайт.
