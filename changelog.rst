...
Версия 2.22
-----------
Добавлена возможность **включать/отключать варианты заказа билетов в отдельных событиях**. Если тот или иной вариант заказа билетов включен в настройках сервиса продажи билетов, но отключен в событии - он НЕ будет отображаться на шаге 2 заказа билетов.

.. Добавлены **наценки на билеты в событиях**.
