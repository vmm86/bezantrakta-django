...
class ProjectCache(ABC):
    ...
    Attributes:
        ...
        database_first (bool): Брать ли данные сразу из БД или из входного объекта.
        in_memory (bool): Использовать кэширование в памяти или файловое кэширование (предпочтиттельно).
    ...
    def get_object(self, object_id, **kwargs):
        """Получение данных для кэширования из модели в БД или из входного объекта.
